...
$(function () {
  ...
  console.log('%c Kyrie %c', 'background:#24272A; color:#ffffff', '', 'https://imoe.pw/')
  console.log('%c Xoyo %c', 'background:#24272A; color:#ffffff', '', 'https://wit.im/')
  console.log('%c Github %c', 'background:#24272A; color:#ffffff', '', 'https://github.com/TheDeathDragon/TheDeathDragon')
})
